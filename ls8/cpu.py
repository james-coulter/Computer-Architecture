...
# Sprint
CMP = 0b10100111  # Compare Registers
...
class CPU:
    ...
    # Calls function at address stored in the register
    def call_inst(self):
        ...
        self.pc = sub
    # Jumps to address stored in the given register
    def jmp_inst(self):
        # print("JMP")
        # Find register
        reg_a = self.ram_read(self.pc + 1)
        # Set PC to the address stored in said register
    ...
    def cmp_inst(self):
        ...
        # E is equal flag. If equal set E to 1 otherwise 0
        if self.reg[reg_a] == self.reg[reg_b]:
            self.E = 1
        else:
            self.E = 0
        # L is Less-Than flag. If Register a < reg b set L to 1 otherwise 0
        if self.reg[reg_a] < self.reg[reg_b]:
            self.L = 1
        else:
            self.L = 0
        # G is Greater-Than flag. If Register a > reg b set G to 1 otherwise 0
        if self.reg[reg_a] > self.reg[reg_b]:
            self.G = 1
        else:
            self.G = 0
